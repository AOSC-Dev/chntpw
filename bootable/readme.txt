...
This directory contains files used for building a bootable media.
You should be able to mostly reuse the contents of `initrd/{init,scripts/}`
for the text interface. For library and kernel module use, refer to the
various "contents" text files in this directory.
